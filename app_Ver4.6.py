# app_Ver4.6.py — 입지 선정 분석 툴 v4.6 (Streamlit 앱)
# 실행: streamlit run app_Ver4.6.py
#
# v4.5 대비 개선 사항 (묶음 A: 코드 정리):
#   1. PRESETS, SIDO_GU_MAP을 config.py로 이동 (단일 소스)
#   2. 페이지 제목 v4.6으로 갱신
#   3. src/ 구버전 파일(_deprecated/)로 정리 완료
#
# 이전 버전(v4.5) 기능 유지:
